  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        ...
        } my-2 outline-none border-none md:scrollbar-thin md:scrollbar-thumb-scroll-light hover:md:scrollbar-thumb-scroll-light-hover [&>h1]:text-lg lg:[&>h1]:text-2xl [&>h1]:font-semibold [&>p]:text-base lg:[&>p]:text-lg [&>ul]:pl-6 lg:[&>ul]:pl-10 [&>ul]:list-disc`,
      },
    },
    onBlur({ editor }) {
