...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-[1000] min-w-[8rem] overflow-hidden rounded-md border border-border-light bg-white p-1 text-text-light-1 shadow-md dark:border-border-dark dark:bg-neutral-950 dark:text-text-dark-1',
