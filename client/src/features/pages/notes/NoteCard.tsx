...
const NoteCard = ({ note }: { note: NoteType }) => {
  ...
  return (
    <li className='before:bg-special-color before:h-full before:w-1.5 before:absolute before:left-0 before:top-0 overflow-hidden relative group cursor-pointer w-full px-3 pl-4 bg-bg-light-3 dark:bg-bg-dark-2 border border-border-light dark:border-border-dark p-2 rounded-lg shadow-sm lg:max-w-[450px]'>
      <BtnMenu>
        <div className='flex justify-between items-center pb-1'>
          <p className='text-sm text-text-light-2 dark:text-text-dark-2 py-1.5'>
        ...
        <h3 className='text-lg font-semibold text-text-light-1 dark:text-text-dark-1'>
          {note.title}
        </h3>
        <Tiptap
          isReadOnly
